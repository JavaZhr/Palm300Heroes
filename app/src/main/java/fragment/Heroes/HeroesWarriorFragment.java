...
public class HeroesWarriorFragment extends Fragment implements HeroesRecyclerViewAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        dataList = DataSupport.where("herotype like ?", "%战士%").find(HeroD.class);
