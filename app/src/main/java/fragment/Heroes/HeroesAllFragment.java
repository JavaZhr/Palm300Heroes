...
public class HeroesAllFragment extends Fragment implements HeroesRecyclerViewAdapter.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onRefresh() {
        ...
        HttpUtil.sendOkHttpRequest(heroAddress, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                dataList.clear();
                dataList.addAll(DataSupport.findAll(HeroD.class));
                getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        swipeRefreshLayout.setRefreshing(false);
