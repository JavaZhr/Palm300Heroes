...
public class HeroesAssassinFragment extends Fragment implements HeroesRecyclerViewAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        HeroesRecyclerViewAdapter recycleAdapter = new HeroesRecyclerViewAdapter(getActivity(), dataList);
