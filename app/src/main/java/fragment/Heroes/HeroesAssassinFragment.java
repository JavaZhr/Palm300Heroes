...
public class HeroesAssassinFragment extends Fragment implements HeroesRecyclerViewAdapter.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        dataList = DataSupport.where("herotype like ?", "%刺客%").find(HeroD.class);
    ...
    public void onRefresh() {
        ...
        HttpUtil.sendOkHttpRequest(heroAddress, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                dataList.clear();
                dataList.addAll(DataSupport.where("herotype like ?", "%刺客%").find(HeroD.class));
                getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        swipeRefreshLayout.setRefreshing(false);
